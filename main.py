...
IMAGE_PAHT = 'images/goose'
PLAYER_IMAGES = os.listdir(IMAGE_PAHT)
...
def create_enemy():
    enemy_size = (30,30)
    enemy = pygame.transform.scale(pygame.image.load('./images/enemy.png').convert_alpha(), (75,45)) 
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(200,1000), -150, *bonus_size)
...
while playing == True :
    ...
    for event in pygame.event.get():
        ...
        if event.type == CHANGE_IMAGE:
            player =pygame.image.load(os.path.join(IMAGE_PAHT, PLAYER_IMAGES[image_index]))  
            image_index+=1
   ...
   # main_display.fill(COLOR_BLACK)
    ...
    main_display.blit(FONT.render('Ваш рахунок: '+str(score)+'',True, COLOR_BLACK), (WIDTH-250, 20))
